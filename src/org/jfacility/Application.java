...
public class Application {
    ...
    private String retrieveRootDirectory() {
        ...
        if (isJar()) {
            ...
            try {
                loc = URLDecoder.decode(CLASS.getProtectionDomain().getCodeSource().getLocation().getFile(), "UTF-8");
            } catch (Exception e) {
    ...
    public void restart(String command) {
        ...
        commands.add(Lang.getJavaHome()+File.separator+"bin"+File.separator+"java");
        commands.add("-jar");

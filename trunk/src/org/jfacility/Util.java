...
public class Util {
     ...
     *
     * @param f filezip da estrarre
     * @param except stringa/nome da escludere dall'estrazione
     * @param path percorso dove si vuole estrarre
     ...
     * @throws IOException
     */
    public static ArrayList<File> unzip(File f, String except) throws ZipException, IOException {
        ZipFile zipFile = new ZipFile(f);        
        return enumerationZip(zipFile, f.getAbsolutePath(), except);
    }
    /**enumera/analizza il file zip
     *
     * @param zipFile filezip da analizzare/enumerare
     * @param path percorso di estrazione
     * @param except stringa/nome da escludere dall'estrazione
     * @return arraylist di file estratti
     * @throws IOException
     */
    private static ArrayList<File> enumerationZip(ZipFile zipFile, String path, String except)
            throws IOException {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (Lang.verifyTextNotNull(zen) && zen.substring(0, except.length()).toLowerCase().
     ...
     * @throws IOException
     */
    private static File writeZip(BufferedInputStream bis, String path, String name) throws IOException{
    ...
    /**Crea un file zip
     *
     * @param array array di file da comprimere
     * @param outFile file zip
     * @throws IOException
     */
    public static void createZip(ArrayList<File> array, File outFile) throws IOException {
